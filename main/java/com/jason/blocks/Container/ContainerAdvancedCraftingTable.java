package com.jason.blocks.Container;
...
public class ContainerAdvancedCraftingTable extends Container {
	...
	public ContainerAdvancedCraftingTable(InventoryPlayer invPlayer, World world, int x, int y, int z) {
	...
	public void onCraftMatrixChanged(IInventory iiventory){
		//craftResult.setInventorySlotContents(0, com.jason.blocks.Crafting.AdvancedCraftingTableCraftingManager.getInstance().findMatchingRecipe(craftMatrix, worldObj));
	}
	
	@Override
	public boolean canInteractWith(EntityPlayer player) {
		if(worldObj.getBlock(posX, posY, posZ) != _MBlocks.BlockAdvancedCraftingTable) {
			return false;
		}else{
